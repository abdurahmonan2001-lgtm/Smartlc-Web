...
The chimney's decline has been as quiet as its rise. Coal fires made the cities of industrial Europe famously filthy, and after the London smog of 1952 killed thousands of people, clean-air legislation pushed households towards smokeless fuel, and central heating then removed the need for a fire in each room. Millions of flues were capped and forgotten. They were not empty, though. The dark sheltered shafts had long been colonised by swifts, which nest in them each summer, and conservationists now ask builders to leave a few of them open.`,
    ...
    },
    {
      ...
      passage: `A — Walk down the main shopping street of almost any medium-sized town in western Europe and you will pass a shuttered unit within a minute. In Britain, roughly one shop in seven now stands empty, and in the weaker centres of the north and west the figure is closer to one in five. The explanations are familiar enough: online retail took a fifth of all spending in barely a decade; the supermarkets and retail parks on the ring road offer parking that costs nothing; and the rents and business taxes attached to a high-street lease were fixed in an age when a shop window was the only way to reach a customer. Banks and building societies have closed their branches along the same streets, removing an errand that once brought people into the centre whether they intended to shop or not. What is far less familiar is the question of what should now be done with the buildings that are left behind.

B — The retail geographer Elena Vasquez argues that the whole debate is framed wrongly. The street lined from end to end with shops, she points out, is not an ancient form but a phase, roughly a hundred and fifty years long, produced by railways, cheap plate glass and a population that had to buy its groceries within walking distance of home. The permanent shopfront, she notes, replaced markets and travelling pedlars that had served the same purpose for centuries without occupying any building at all. Towns went on adding retail floorspace long after that logic had gone, and England built more shops in the twenty years to 2008 than in the previous fifty. Counting shops, in her view, is the wrong measure of a town centre's health. The right one is how many people come, how long they stay and how many separate reasons they have for being there at all.

C — That is not an argument for complacency, because empty units are not neutral. The economist Karl Lindqvist has tracked turnover street by street in a dozen towns and finds that vacancy is contagious: each additional closed unit in a run of shops reduces the takings of its neighbours measurably, because shoppers judge a street at a glance and walk away from one that looks abandoned. Lost trade then closes the next business, which lowers footfall again. The damage is heaviest, his figures show, where the closures fall together in one stretch rather than scattered singly around a town. Lindqvist calls the result a doom loop, and observes that it can run on for years after the original cause of the closures has disappeared.
...
That changed in 2003, when two American psychologists proposed a working definition with two parts. The first is perceived vastness: the encounter must present something on a scale far beyond the observer, whether in size, number, authority or skill. The second, and the more interesting, is a need for accommodation, meaning the sense that one's existing mental categories cannot absorb what is in front of one and must be stretched or rebuilt. The pair borrowed that term from developmental psychology, where a child who meets an animal that will not fit the category 'dog' has to build a wider one. Vastness need not be physical. A mathematical proof, a piece of music or an act of moral courage can all deliver it. Accommodation is what separates awe from ordinary pleasure: a beautiful meal does not require you to revise your model of the world, and a supernova does.
...
The most reliable finding concerns the self. People who have just experienced awe describe themselves as smaller and less significant; asked to draw themselves in a landscape, they draw a smaller figure; asked to write about the experience, they use fewer first-person singular pronouns. The drawing task has since been repeated in several countries, and the figure comes out smaller in each of them. Researchers call this the small self, and it is easy to misread. It is not a loss of confidence, and it is not a low mood. On every measure of well-being taken at the same moment, the participants are doing better than before rather than worse. The self shrinks, but it does not suffer; what falls away is the constant background calculation of one's own standing.

Downstream of that shrinking, the effects run outward. Volunteers who have watched footage of vast landscapes, or looked up for a minute into a stand of tall trees, are more likely to help a stranger who drops a handful of pens, more generous in economic games, more patient, and more inclined to judge that they have plenty of time. In one study the awe condition handed over a larger share of a small cash payment to a stranger than volunteers who had watched an amusing film. The mechanism proposed is simple: attention has been pulled outward, and rumination, which is attention pulled inward, stops for a while.

It is here that caution is needed, and the field has not always shown it. Most of these results come from brief laboratory manipulations, a two-minute video or a guided recollection, measured immediately afterwards, and the effects, while real, are modest. Some have replicated well and some have not. A multi-site attempt on the small-self effect recovered it, though at roughly half the size first reported. The best-known field study asked older adults to take a weekly walk with instructions to look for whatever surprised them, and reported more smiling and less distress after eight weeks; it is a genuinely promising result from a sample of fifty-two people. The evidence that a moment of awe can change an afternoon is decent. The claim, now standard in wellness marketing, that awe repairs the immune system or lifts a depression is not supported, and the long-term claims run well ahead of the data.
