...
For the next thousand years European locksmiths mostly elaborated what the Romans had left them. Wards grew into mazes of curling metal, cases were engraved and gilded, and a great house might own a lock that was as much furniture as security. The trouble is that a ward tests the shape of the key's edge and nothing else. A thief who filed away everything except the outer rim of a blank had a key that slipped past the wards of an entire household — the tool later known as the skeleton key. Medieval locks looked formidable and were, in the main, an advertisement.
