...
Forecasters today run their models dozens of times with slightly varied starting conditions, reading the spread of results as a measure of confidence. Chaos sets a horizon of roughly two weeks on useful detail, yet within it the gains have been steady: a five-day forecast now is about as reliable as a one-day forecast was in 1980.`,
      questions: [
        { n: 1, type: "gap", prompt: "Torricelli's barometer consisted of a dish and a glass tube filled with ______.", note: "ONE WORD ONLY", answer: "mercury",
          explain: "The passage says Torricelli 'filled a glass tube with mercury' and upended it in a dish — the exact noun needed, with no paraphrase to decode here.",
          evidence: "filled a glass tube with mercury" },
        { n: 2, type: "gap", prompt: "The barometer could sense coming ______ before anyone was able to see them.", note: "ONE WORD ONLY", answer: "storms",
          explain: "The barometer 'felt tomorrow's storms' before any human eye could see them. The question paraphrases 'felt' as 'sense', so look for that idea, not the exact word.",
          evidence: "felt tomorrow's storms before any human eye could see them",
          vocab: ["felt", "sense"] },
        { n: 3, type: "gap", prompt: "From the 1840s, the ______ allowed distant observations to be collected while the weather was still travelling.", note: "ONE WORD ONLY", answer: "telegraph",
          explain: "The date 1840s points you to the sentence introducing the electric telegraph, which let distant observations be gathered on one desk while the weather was still travelling.",
          evidence: "The solution appeared in the 1840s with the electric telegraph",
          vocab: ["gathered", "collected"] },
        { n: 4, type: "gap", prompt: "FitzRoy's daily predictions appeared in a London ______.", note: "ONE WORD ONLY", answer: "newspaper",
          explain: "In 1861 FitzRoy began 'publishing predictions of the next day's weather in a London newspaper'. The noun after 'London' in the passage is exactly what the gap needs.",
          evidence: "publishing predictions of the next day's weather in a London newspaper" },
        { n: 5, type: "gap", prompt: "Richardson pictured thousands of human computers working together inside an enormous circular ______.", note: "ONE WORD ONLY", answer: "theatre",
          explain: "Richardson imagined a 'vast circular theatre' holding thousands of human computers. The question paraphrases 'vast' as 'enormous', so the missing noun is 'theatre'.",
          evidence: "a vast circular theatre holding sixty-four thousand human computers",
          vocab: ["vast", "enormous"] },
        { n: 6, type: "gap", prompt: "From 1960, TIROS-1 sent back pictures of the ______ taken from space.", note: "ONE WORD ONLY", answer: "clouds",
          explain: "TIROS-1 'began transmitting photographs of the clouds from orbit'. The question turns 'transmitting photographs' into 'sent back pictures' and 'orbit' into 'space'.",
          evidence: "transmitting photographs of the clouds from orbit",
          vocab: ["transmitting photographs", "sent back pictures"] },
        { n: 7, type: "tfng", prompt: "Aristotle's explanation of the weather was accepted in Europe for a very long time.", answer: "TRUE",
          explain: "TRUE: although much of his account was wrong, it stayed the standard European explanation for almost two millennia — 'nearly two thousand years' matches 'a very long time'.",
          evidence: "remained the standard European explanation of the weather for nearly two thousand years",
          vocab: ["nearly two thousand years", "a very long time"] },
        { n: 8, type: "tfng", prompt: "The barometer's usefulness for prediction was recognised as soon as it was invented.", answer: "FALSE",
          explain: "FALSE: the passage says it took decades for observers to see the instrument's practical value — the direct opposite of 'as soon as it was invented'.",
          evidence: "It took decades for observers to notice the instrument's practical value",
          vocab: ["notice", "recognise"] },
        { n: 9, type: "tfng", prompt: "Fishing communities helped to pay for FitzRoy's storm-warning system.", answer: "NOT GIVEN",
          explain: "NOT GIVEN: the warnings protected fishing boats, but the passage never says who paid for the system. Seeing 'fishing' in the text is not evidence about funding.",
          evidence: "signals were hoisted in the harbours to keep fishing boats at home" },
        { n: 10, type: "tfng", prompt: "Some newspapers mocked FitzRoy's forecasts when they proved wrong.", answer: "TRUE",
          explain: "TRUE: rival papers ridiculed the forecasts whenever rain fell on a promised fine day — 'made fun of' is the passage's paraphrase of 'mocked'.",
          evidence: "rival papers made fun of the forecasts",
          vocab: ["made fun of", "mocked"] },
        { n: 11, type: "tfng", prompt: "Richardson's hand-calculated forecast turned out to be broadly correct.", answer: "FALSE",
          explain: "FALSE: the result was 'wildly wrong'; only the method behind it was sound. The statement's 'broadly correct' contradicts the passage directly.",
          evidence: "The result was wildly wrong, but the method was sound" },
        { n: 12, type: "tfng", prompt: "Satellite pictures made it possible to observe storms developing far from land.", answer: "TRUE",
          explain: "TRUE: after TIROS-1, storms brewing over the oceans could at last be watched as they formed — 'far out over the oceans' matches 'far from land'.",
          evidence: "storms brewing far out over the oceans, invisible to every land station",
          vocab: ["over the oceans", "far from land"] },
        { n: 13, type: "tfng", prompt: "Modern forecasting models are updated several times every day.", answer: "NOT GIVEN",
          explain: "NOT GIVEN: models are run dozens of times with varied starting conditions, but that describes one ensemble of runs — the passage never says how often forecasts are updated each day.",
          evidence: "run their models dozens of times with slightly varied starting conditions" },
      ],
    },
    {
      title: "Passage 2",
...
G — The projects that avoid these traps, argues the planner Lucia Fernandez, are the ones that treat local people as partners rather than beneficiaries. In the schemes she advises, residents help choose the site and the design, school classes adopt stretches of bank, and trained volunteers — many of them retired — carry out the routine water testing that would otherwise consume the maintenance budget. Involvement of that kind, she argues, is what turns a municipal drainage scheme into a place people defend. The marshes our great-grandparents buried will not all come back; but a city that restores even a few of them recovers something useful, cheap and, on a summer evening loud with frogs, unexpectedly loved.`,
      questions: [
        { n: 14, type: "match", group: "info",
          ...
          explain: "Paragraph C sets wetland storage against 'the conventional alternative' of drains, tanks and channels, and gives Okafor's calculation of the price difference — that is the cost comparison.",
          evidence: "wetland storage typically costs less than a third as much per flood",
          vocab: ["the conventional alternative", "conventional engineering"] },
        { n: 15, type: "match", group: "info", prompt: "examples of cities built on land where wetlands were destroyed", answer: "A",
          explain: "Paragraph A names Mexico City and Boston as cities standing on former lake bed and filled marshland — the examples the question asks for. 'Drained, filled and buried' paraphrases 'destroyed'.",
          evidence: "Mexico City stands on the bed of a lake",
          vocab: ["drained, filled and buried", "destroyed"] },
        { n: 16, type: "match", group: "info", prompt: "an account of how wetland plants and the organisms on them clean polluted water", answer: "D",
          explain: "Paragraph D explains purification: plants absorb nitrogen and phosphorus while bacteria on their stems and roots break down oils — the bacteria are the question's 'organisms'.",
          evidence: "bacteria living on their submerged stems and roots break down oils",
          vocab: ["bacteria", "organisms"] },
        { n: 17, type: "match", group: "info", prompt: "a warning that restoration can harm the people it was intended to help", answer: "F",
          explain: "Paragraph F carries Berg's warning: rising rents around wetland parks push out long-standing residents, so a project sold as a public good can end up harming them.",
          evidence: "can quietly become a machine for displacement",
          vocab: ["machine for displacement", "harm the people"] },
        { n: 18, type: "match", group: "info", prompt: "a measured difference in temperature between a wetland and nearby streets", answer: "E",
          explain: "Paragraph E gives the actual figure from Raman's instruments: air above the ponds was three degrees cooler than the streets — a measured temperature difference.",
          evidence: "air above the ponds three degrees cooler than the streets",
          vocab: ["three degrees cooler", "difference in temperature"] },
        { n: 19, type: "gap", group: "sum2", note: "ONE WORD ONLY",
          ...
          answer: "sponge",
          explain: "Okafor says a restored wetland 'behaves like a sponge', storing storm water and releasing it slowly. The summary's 'acts like' paraphrases 'behaves like', so 'sponge' fills the gap.",
          evidence: "behaves like a sponge",
          vocab: ["behaves like", "acts like"] },
        { n: 20, type: "gap", group: "sum2", answer: "sediment",
          explain: "As the flow slows, 'the sediment it carries' — grit, soil, metal particles — drops to the bottom. The summary paraphrases 'settles' as 'sinks', keeping 'sediment' as the answer.",
          evidence: "the sediment it carries",
          vocab: ["settles to the bottom", "sinks to the bottom"] },
        { n: 21, type: "gap", group: "sum2", answer: "bacteria",
          explain: "The agents that break down oils and other organic pollutants are the bacteria on the plants' submerged stems and roots — the summary repeats the passage's wording almost exactly.",
          evidence: "bacteria living on their submerged stems and roots" },
        { n: 22, type: "gap", group: "sum2", answer: "channels",
          explain: "The conventional alternative is to build 'underground storage tanks and concrete channels'. The summary keeps 'tanks and concrete' and asks for the final noun of that list.",
          evidence: "underground storage tanks and concrete channels" },
        { n: 23, type: "match", group: "people", boxTitle: "List of People",
          ...
          explain: "Suzuki, the ecologist who surveys restored wetlands, reports dragonflies within months and otters by year three — recovery so fast it 'surprises even the people who planned it'.",
          evidence: "the speed of the recovery surprises even the people who planned it",
          vocab: ["surprises even the people", "than anyone had expected"] },
        { n: 24, type: "match", group: "people", prompt: "Natural flood storage is far cheaper than building the equivalent engineering.", answer: "A",
          explain: "The engineer Okafor makes the cost calculation: wetland storage comes to under a third of the price of tanks and channels — 'less than a third' paraphrases 'far cheaper'.",
          evidence: "costs less than a third as much per flood",
          vocab: ["less than a third", "far cheaper"] },
        { n: 25, type: "match", group: "people", prompt: "Living close to restored water is associated with measurable health benefits.", answer: "E",
          explain: "The public-health researcher Raman tracked residents near restored ponds and found lower stress and measurably lower blood pressure — the 'measurable health benefits' of the statement.",
          evidence: "measurably lower blood pressure than matched neighbours",
          vocab: ["lower blood pressure", "health benefits"] },
        { n: 26, type: "match", group: "people", prompt: "Wetland projects can make an area too expensive for its existing residents.", answer: "B",
          explain: "The geographer Berg studied property markets around wetland parks: rents and prices rose so fast that established residents were priced out — 'could no longer afford' means 'too expensive'.",
          evidence: "many long-standing residents could no longer afford to stay",
          vocab: ["could no longer afford", "too expensive"] },
      ],
    },
    {
      title: "Passage 3",
...
What works better is redesign. The most reliable technique keeps the cue and the reward but swaps the routine: the smoker who wants a break and a moment of relief learns to take the same break with different props. Because the old loop's scaffolding is reused rather than fought, substitution succeeds far more often than suppression. The second technique is friction: make the unwanted behaviour slightly harder — delete the app, put the biscuits on a high shelf — and make the wanted one slightly easier. The effect requires no vigilance at all; the loop simply fires less often because the path is longer. None of this is heroic, and that is the point. We flatter ourselves that character drives behaviour, but the evidence says environment writes most of the script. The person who seems disciplined has usually just built a life in which the right actions are the easy ones — and that skill, unlike willpower, is available to anyone.`,
      questions: [
        { n: 27, type: "mcq", prompt: "In the first paragraph, the writer's main point is that", options: ["A most people regret how they spend their mornings", "B a large share of daily behaviour happens without deliberate decision", "C morning routines are the most difficult habits to change", "D researchers disagree about how to measure habits"], answer: "B",
          explain: "The paragraph's central claim is that roughly forty per cent of daily behaviour is repeated rather than decided — behaviour without deliberate decision. Regret and disagreement among researchers are never mentioned.",
          evidence: "roughly forty per cent of what we do is not decided at all",
          vocab: ["not decided at all", "without deliberate decision"] },
        { n: 28, type: "mcq", prompt: "What does the writer say about the claim that habits take twenty-one days to form?", options: ["A It was deliberately invented to sell books", "B It applies only to simple physical habits", "C It has been confirmed for most volunteers", "D Research shows the true time differs enormously between people"], answer: "D",
          explain: "The study found times from eighteen days to over two hundred and fifty — the range 'differs enormously between people'. The figure is called false, not invented to sell books, so A is a trap.",
          evidence: "the range ran from eighteen days to more than two hundred and fifty",
          vocab: ["the range ran", "differs enormously"] },
        { n: 29, type: "mcq", prompt: "According to the writer, moving to a new home often weakens old habits because", options: ["A the triggers that started the routines are no longer present", "B people feel more energetic in new surroundings", "C there is less time available for old routines", "D the rewards of old habits become less satisfying"], answer: "A",
          explain: "Habits belong to places: after a move, 'the old cues are simply no longer there to fire the old routines'. The passage's 'cues' are the question's 'triggers'.",
          evidence: "the old cues are simply no longer there to fire the old routines",
          vocab: ["cues", "triggers"] },
        { n: 30, type: "mcq", prompt: "The writer's view of willpower is that", options: ["A it grows stronger with regular practice", "B it matters more than the design of one's surroundings", "C it is too unreliable to be the main weapon against a habit", "D it fails only in people under unusual stress"], answer: "C",
          explain: "Willpower fluctuates with stress, sleep and hunger, and must win every single confrontation while the habit needs to win only once — too unreliable to be the main weapon.",
          evidence: "it fluctuates with stress, sleep and hunger",
          vocab: ["fluctuates", "unreliable"] },
        { n: 31, type: "ynng", prompt: "Habits are, on the whole, a useful feature of human behaviour.", answer: "YES",
          explain: "YES: the writer calls the arrangement 'a triumph of design' because habit frees scarce conscious attention for problems that deserve it — clearly a useful feature overall.",
          evidence: "the arrangement is a triumph of design",
          vocab: ["a triumph of design", "a useful feature"] },
        { n: 32, type: "ynng", prompt: "An established habit can be completely removed from the brain.", answer: "NO",
          explain: "NO: brain-imaging and relapse studies agree a habit is 'never truly deleted, only overlaid with newer learning' — the direct opposite of being completely removed.",
          evidence: "an established habit is never truly deleted, only overlaid with newer learning",
          vocab: ["never truly deleted", "completely removed"] },
        { n: 33, type: "ynng", prompt: "Children develop new habits more easily than adults.", answer: "NOT GIVEN",
          explain: "NOT GIVEN: formation time varies with the person and the behaviour's complexity, but children and adults are never compared anywhere in the passage — do not supply outside knowledge.",
          evidence: "depending on the person and the complexity of the behaviour" },
        { n: 34, type: "ynng", prompt: "Changing one's environment is a better strategy than relying on determination.", answer: "YES",
          explain: "YES: the writer calls 'gritted teeth' a poorly chosen strategy and argues that redesigning one's surroundings works better — environment, not character, writes most of the script.",
          evidence: "the evidence says environment writes most of the script",
          vocab: ["gritted teeth", "determination"] },
        { n: 35, type: "ynng", prompt: "Returning to an old habit after years of abstinence shows a weak character.", answer: "NO",
          explain: "NO: the writer says reading such relapses as weakness of character is 'simply a mistake', because the old loop survives underneath — the statement is directly rejected.",
          evidence: "To interpret such relapses as weakness of character" },
        { n: 36, type: "match", group: "ends", boxTitle: "Sentence endings",
          ...
          explain: "The basal ganglia 'specialises in storing well-practised sequences' and runs them 'almost without conscious supervision' — ending E paraphrases this as 'little conscious attention'.",
          evidence: "specialises in storing well-practised sequences",
          vocab: ["without conscious supervision", "little conscious attention"] },
        { n: 37, type: "match", group: "ends", prompt: "The reward at the end of a habit loop", answer: "B",
          explain: "Each reward strengthens the link, 'instructing the brain to launch the routine the next time the cue appears' — ending B, with 'launch' paraphrased as 'start'. Ending C says the opposite of the passage.",
          evidence: "instructing the brain to launch the routine the next time the cue appears",
          vocab: ["launch", "start"] },
        { n: 38, type: "match", group: "ends", prompt: "The most widely cited study of habit formation", answer: "A",
          explain: "The study's real finding was the huge variation — eighteen days to over two hundred and fifty — so ending A, 'great differences', fits. Ending F contradicts the passage.",
          evidence: "The average time to full automaticity was sixty-six days",
          vocab: ["full automaticity", "become automatic"] },
        { n: 39, type: "match", group: "ends", prompt: "Replacing the routine while keeping the cue and the reward", answer: "G",
          explain: "This technique is substitution, and because the old loop's scaffolding is reused rather than fought, it 'succeeds far more often than suppression' — ending G.",
          evidence: "substitution succeeds far more often than suppression",
          vocab: ["swaps the routine", "replacing the routine"] },
        { n: 40, type: "match", group: "ends", prompt: "Making an unwanted habit harder to perform", answer: "D",
          explain: "Friction works with no vigilance: the loop 'simply fires less often because the path is longer' — ending D, reducing the behaviour 'without any deliberate effort'.",
          evidence: "the loop simply fires less often because the path is longer",
          vocab: ["no vigilance at all", "without any deliberate effort"] },
      ],
    },
  ],
};
