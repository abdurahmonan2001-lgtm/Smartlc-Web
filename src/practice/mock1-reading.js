...
The consequences reached far beyond the docks. Because moving goods became astonishingly cheap, manufacturers no longer needed to sit close to their customers. Factories migrated to wherever production costs were lowest, and complex products began to cross oceans several times before completion. Economists still debate the exact numbers, but many argue that the container did more to accelerate global trade in the twentieth century than every tariff negotiation of the same period combined. The old ports, meanwhile, were transformed beyond recognition. Cities such as London and New York, whose docklands once employed tens of thousands, watched the work move to deep-water terminals outside the city, run by a handful of crane operators. The romance of the waterfront gave way to the quiet efficiency of the box.`,
    ...
    {
      title: "Passage 2",
      instructions: "You should spend about 20 minutes on Questions 14–26, which are based on Reading Passage 2. Questions 14–18: choose the correct heading for each paragraph. Questions 19–26: answer as instructed.",
...
E — Perhaps the most durable argument for growing food in cities is not efficiency but resilience. When a port closes, a border tightens or a drought strikes, a city that grows even a modest share of its own vegetables has options that others lack. Supporters see vertical farms not as a replacement for the countryside, but as an insurance policy against a more turbulent world — one paid for, willingly, in electricity bills.`,
      questions: [
        { n: 14, type: "select", prompt: "Paragraph A", options: ["i An industry that grew quickly", "ii The problem of electricity", "iii Insurance for uncertain times", "iv What vertical farms choose to grow", "v Saving land and water", "vi The crops of the future"], answer: "i" },
        { n: 15, type: "select", prompt: "Paragraph B", options: ["i An industry that grew quickly", "ii The problem of electricity", "iii Insurance for uncertain times", "iv What vertical farms choose to grow", "v Saving land and water", "vi The crops of the future"], answer: "v" },
        { n: 16, type: "select", prompt: "Paragraph C", options: ["i An industry that grew quickly", "ii The problem of electricity", "iii Insurance for uncertain times", "iv What vertical farms choose to grow", "v Saving land and water", "vi The crops of the future"], answer: "ii" },
        { n: 17, type: "select", prompt: "Paragraph D", options: ["i An industry that grew quickly", "ii The problem of electricity", "iii Insurance for uncertain times", "iv What vertical farms choose to grow", "v Saving land and water", "vi The crops of the future"], answer: "iv" },
        { n: 18, type: "select", prompt: "Paragraph E", options: ["i An industry that grew quickly", "ii The problem of electricity", "iii Insurance for uncertain times", "iv What vertical farms choose to grow", "v Saving land and water", "vi The crops of the future"], answer: "iii" },
        { n: 19, type: "gap", prompt: "Closed watering systems can cut water use by up to ______ per cent.", note: "A NUMBER", answer: "ninety-five" },
        { n: 20, type: "gap", prompt: "Lighting can make up over half of a vertical farm's ______ costs.", note: "ONE WORD ONLY", answer: "running" },
        { n: 21, type: "gap", prompt: "Indoor salads may have a larger carbon footprint unless electricity is ______.", note: "ONE WORD ONLY", answer: "renewable" },
        { n: 22, type: "mcq", prompt: "Why do vertical farms concentrate on leafy greens and herbs?", options: ["A They are the healthiest crops", "B They grow fast and sell at high prices", "C They need no electricity", "D Customers refuse other vegetables"], answer: "B" },
        { n: 23, type: "mcq", prompt: "According to the passage, wheat and rice grown indoors are", options: ["A becoming cheaper each year", "B already sold in supermarkets", "C not economically realistic", "D banned in most countries"], answer: "C" },
        { n: 24, type: "tfng", prompt: "Commercial vertical farms operate in at least four countries.", answer: "TRUE" },
        { n: 25, type: "tfng", prompt: "Most researchers expect potatoes to be grown indoors profitably within a decade.", answer: "FALSE" },
        { n: 26, type: "tfng", prompt: "The writer believes vertical farms will replace traditional agriculture.", answer: "FALSE" },
      ],
    },
    {
      title: "Passage 3",
...
None of this means that all forgetting is benign; the losses of dementia are not a filter but a fire. The researchers' claim is narrower and stranger: that a healthy memory is defined not by how much it keeps, but by how well it chooses what to lose. Remembering and forgetting, long cast as opponents, are better understood as partners in the same enterprise — a collaboration, conducted below awareness, that decides who we are able to be today.`,
      questions: [
        ...
        { n: 36, type: "gap", prompt: "Forgetting works as a ______ that keeps relevant information findable.", note: "ONE WORD ONLY", answer: "filter" },
        { n: 37, type: "gap", prompt: "Repeatedly retrieving one memory makes competing memories harder to ______.", note: "ONE WORD ONLY", answer: "recall" },
        { n: 38, type: "gap", prompt: "Some species have identifiable ______ that dismantle memories.", note: "ONE WORD ONLY", answer: "cells" },
        { n: 39, type: "gap", prompt: "The losses caused by dementia are compared to a ______.", note: "ONE WORD ONLY", answer: "fire" },
        { n: 40, type: "gap", prompt: "Remembering and forgetting are described as ______ in the same enterprise.", note: "ONE WORD ONLY", answer: "partners" },
      ],
    },
  ],
};
