...
F — The strongest criticism is not that these schemes fail but that they are unfair. The urban geographer Stefan Weiss maps traffic before and after, and points out that the roads which absorb whatever does not evaporate are usually the boundary roads: wider, poorer, already noisier, and lined with the cheapest housing in the district. A filtered neighbourhood can therefore export its dirty air and its noise to the people least able to object. Weiss adds two complaints supporters brush aside too quickly. Drivers with disabilities may depend on the door they are no longer permitted to reach, and the residents who dominate consultation meetings are, everywhere he has looked, the older and more confident half of the street.
