...
Sleep also matters before learning, not only after it. Volunteers kept awake for a night and then shown a long list of images take in markedly less of it than volunteers who have slept, and brain imaging locates the failure in the hippocampus itself, which behaves as though there were no room left to write in. The deficit is not simply a matter of feeling tired: it appears in volunteers who rate themselves alert. On this account a night without sleep costs a student twice: once for the material learnt the day before, which is never properly filed, and once for the material of the following day, which is barely taken in.
