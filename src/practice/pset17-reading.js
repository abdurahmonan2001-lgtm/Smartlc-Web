...
B — Against that background, second-hand clothing has become unexpectedly fashionable. Resale platforms have turned the wardrobe into something closer to a portfolio, to be traded rather than emptied, and charity shops have redesigned themselves to look like boutiques. Most shoppers under thirty now buy used clothes at least once a year, and the resale market is growing several times faster than the sale of new clothes. Renting has grown alongside it, at first for the sort of occasion dress that is worn once, and lately by subscription, so that a wardrobe arrives by post and leaves again a month later. Repair has been rediscovered too, and menders and alteration counters that were closing twenty years ago now take bookings. Whether that growth displaces new production, or merely adds a second purchase to the first, nobody has yet shown.
