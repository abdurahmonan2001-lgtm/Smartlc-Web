...
The pack has resisted every improvement offered to it since. Manufacturers have tried five suits, round cards, packs of sixty-five and cards that cannot be marked; all of them failed in the market. A pack of transparent cards, patented in the 1930s, sold briskly for a single season and was never reordered. What survives is a fifteenth-century Egyptian structure wearing a fifteenth-century French costume, printed by the million, and still the cheapest portable machine for generating uncertainty that anyone has managed to build.`,
      questions: [
...
Afterwards, the currency changes. A period that has ended can only be judged by what remains of it, and what remains is events. A week of travel, in which nothing was familiar and every hour laid down something new, is remembered as long. A week at a desk, in which each day resembled the last and the brain sensibly stored one copy rather than five, shrinks to almost nothing in recall. Ask somebody in December how long October felt, and the answer tracks the number of separable episodes the month contained rather than the number of days it held. This is the origin of the holiday paradox. A good holiday passes quickly while it is happening, because attention is fully occupied, and is remembered as enormous, because it left so much behind. The clock, meanwhile, recorded the same fourteen days throughout.

The same machinery accounts for the complaint that the years accelerate with age. The popular explanation is proportional: a year is a tenth of the life of a ten-year-old and a fiftieth of a fifty-year-old's, so it must feel smaller. The theory is neat, and it is very poorly supported; when researchers actually ask people to judge durations, the ratio predicts almost nothing about their answers. The memory account does better. Childhood and early adulthood are crowded with events that happen exactly once — a first journey alone, a first job — while later decades tend to be organised, repetitive and therefore efficiently compressed. The pattern is not a failure of recall — what was laid down stays as available as ever — but a change in how much there was to lay down. Time is not passing faster. It is being recorded more thinly, and the thinness is felt only in retrospect.
