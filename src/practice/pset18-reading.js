  ...
  sections: [
    {
      ...
      passage: `For most of human history every stitch in every garment was made by hand. A skilled seamstress working steadily could manage perhaps thirty-five stitches a minute, and a single shirt, with its collar, cuffs and buttonholes, took her the better part of fourteen hours. Clothing was therefore expensive, wardrobes were small, and the making of clothes occupied an enormous and largely invisible workforce of women. A labourer might own two shirts and expect both to be patched, turned and mended until the cloth finally gave way. The machine that ended this arrangement arrived late, and it arrived in pieces. No single inventor produced it, and almost every man who supplied one part of the solution was ignored, ruined or sued.
...
D — The economics are what persuade finance committees, and the water engineer Ana Duarte has spent years assembling them. A public fountain, she points out, costs a few thousand pounds to install and a few hundred a year to service, while the water it delivers is almost free: mains water in most European cities costs a fraction of a penny a litre, against roughly a pound a litre for the bottled equivalent. One busy fountain can replace tens of thousands of half-litre bottles in a single summer. Measured against the bottles it replaces, Duarte calculates, a well-used city-centre fountain repays its whole installation cost within about three years, and everything after that is a gain to the public purse. The figures collapse, she readily concedes, if the fountain is placed somewhere nobody walks.

E — The health case is broader than thirst. The public-health researcher Idris Coker studies what happens to cities in extreme heat, and his findings are blunt: during a heatwave the people who suffer first are those who cannot easily get out of the sun and cannot afford to buy a drink, among them outdoor workers, older people on foot and anyone sleeping rough. Thirst in such conditions is not a discomfort but a medical event, and ambulance services record their busiest days of the year at exactly these times. Free water in the street, he argues, is the cheapest heat protection a council can buy.
