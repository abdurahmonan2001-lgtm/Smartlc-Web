...
Today the dictionary maker's raw material has changed again. Instead of slips in pigeonholes, editors search a corpus — an enormous electronic collection of real texts, from novels to news reports — to see how words actually behave, and definitions describe usage rather than dictate it. Publication has changed even more. An online dictionary can add a word within weeks of its first appearance and revise an entry continuously, instead of waiting years for a new edition. What has not changed is the essential task Cawdrey set himself four centuries ago: explaining words, plainly, to the people who need them.`,
      questions: [
        { n: 1, type: "gap", prompt: "The earliest known word lists were written on clay ______.", note: "ONE WORD ONLY", answer: "tablets",
          explain: "The opening sentence says the oldest word lists were pressed into clay tablets, so 'tablets' completes the phrase. Keep the plural, as in the passage.",
          evidence: "pressed into clay tablets nearly four thousand years ago" },
        { n: 2, type: "gap", prompt: "Cawdrey's title page said the book was written partly for ______.", note: "ONE WORD ONLY", answer: "women",
          explain: "The title page declared the book was written for the benefit of women and other readers without Latin or Greek, so 'women' fills the gap after 'partly for'.",
          evidence: "the book was written for the benefit of women",
          vocab: ["for the benefit of", "partly for"] },
        { n: 3, type: "gap", prompt: "Johnson was helped in his attic workroom by six ______.", note: "ONE WORD ONLY", answer: "assistants",
          explain: "Johnson worked in the attic of his house helped by six assistants who copied the quotations, so 'assistants' follows 'six'. 'Attic workroom' paraphrases 'attic of his house'.",
          evidence: "he was helped by six assistants",
          vocab: ["attic of his house", "attic workroom"] },
        { n: 4, type: "gap", prompt: "Quotations for the Oxford dictionary were collected by volunteer ______.", note: "ONE WORD ONLY", answer: "readers",
          explain: "The material was gathered by an army of volunteer readers who sent in slips, so 'readers' completes the phrase; 'collected' in the question paraphrases 'gathered'.",
          evidence: "gathered by an army of volunteer readers",
        ...
        { n: 5, type: "gap", prompt: "Murray stored the quotation slips in a garden shed he called the ______.", note: "ONE WORD ONLY", answer: "Scriptorium",
          explain: "Murray built a corrugated-iron shed in his garden and named it the Scriptorium. It is a proper name, so copy the capital letter exactly.",
          evidence: "hundreds of pigeonholes for the slips, and named it the Scriptorium",
          vocab: ["shed in his garden", "garden shed"] },
        { n: 6, type: "gap", prompt: "Modern editors study word behaviour in a large electronic collection of texts called a ______.", note: "ONE WORD ONLY", answer: "corpus",
          explain: "The final paragraph defines the corpus as an enormous electronic collection of real texts, so 'corpus' is the name the gap asks for; 'large' paraphrases 'enormous'.",
          evidence: "an enormous electronic collection of real texts, from novels to news reports",
          vocab: ["enormous", "large"] },
        { n: 7, type: "gap", prompt: "Online dictionaries can be updated continuously rather than waiting for a new ______.", note: "ONE WORD ONLY", answer: "edition",
          explain: "Online dictionaries revise entries continuously instead of waiting years for a new edition, so 'edition' completes 'a new ______'; 'updated' paraphrases 'revise'.",
          evidence: "instead of waiting years for a new edition",
          vocab: ["revise an entry continuously", "updated continuously"] },
        { n: 8, type: "tfng", prompt: "The word lists of Mesopotamia were arranged in alphabetical order.", answer: "FALSE",
          explain: "FALSE because the passage states the direct opposite: the earliest lists were not alphabetical but grouped by subject, such as trees, professions and animals.",
          evidence: "These earliest reference works were not arranged alphabetically" },
        { n: 9, type: "tfng", prompt: "Cawdrey's dictionary explained only a small part of the English vocabulary.", answer: "TRUE",
          explain: "TRUE: Cawdrey listed only the hard borrowed words, about two and a half thousand entries — the 'difficult fringe' of English, which is exactly a small part.",
          evidence: "Cawdrey made no attempt to cover the whole language",
          vocab: ["the difficult fringe", "a small part"] },
        { n: 10, type: "tfng", prompt: "Johnson's dictionary sold well as soon as it was published.", answer: "NOT GIVEN",
          explain: "NOT GIVEN: the passage tells us when the dictionary appeared and how it was made, but says nothing at all about how well it sold. Do not assume success.",
          evidence: "Dictionary of the English Language appeared in 1755" },
        { n: 11, type: "tfng", prompt: "All of Webster's proposed spellings were accepted by the American public.", answer: "FALSE",
          explain: "FALSE — 'All' is the key word. Some reforms like 'center' were adopted, but others, such as spelling tongue as 'tung', were quietly ignored by the public.",
          evidence: "his proposal to write tongue as tung, were quietly ignored",
          vocab: ["were adopted", "were accepted"] },
        { n: 12, type: "tfng", prompt: "The Oxford English Dictionary took much longer to complete than its editors first expected.", answer: "TRUE",
          explain: "TRUE: the editors first believed the work might take about ten years, yet the final section appeared seventy years after the proposal — far longer than expected.",
          evidence: "not published until 1928, seventy years after the project was proposed",
          vocab: ["first believed", "first expected"] },
        { n: 13, type: "tfng", prompt: "Printed dictionaries will eventually stop being produced.", answer: "NOT GIVEN",
          explain: "NOT GIVEN: the passage contrasts online publishing with waiting for printed editions, but it never predicts that printed dictionaries will disappear. Avoid adding your own opinion.",
          evidence: "An online dictionary can add a word within weeks" },
      ],
    },
    {
      title: "Passage 2",
...
F — Defenders reply that the litre-for-litre ledger misses most of what harvesting actually does. The engineer Marcus Bell points out that every tank that fills during a storm is also flood protection, quietly subtracting water from the surge that would otherwise swamp the drains, and that a city whose roofs feed its aquifer holds a reserve that keeps working when pipes burst or reservoirs run low. The real product, Bell argues, is not cheap water but resilience, and resilience never looks economic until the day it is needed. On one point, every camp agrees, and it echoes Qureshi's history lesson: tanks and recharge wells are not machines that can be installed and forgotten, but small pieces of infrastructure that live or die by maintenance — and by whether the people who own the roofs believe the water belongs to them.`,
      questions: [
        { n: 14, type: "match", group: "minfo", letters: "ABCDEF",
          ...
          explain: "Paragraph D describes Tucson's rebates, which repay households part of the cost of tanks and rain gardens — money offered to persuade people, i.e. financial encouragement.",
          evidence: "the city hands out rebates that repay households part of the cost",
          vocab: ["rebates", "financial encouragement"] },
        { n: 15, type: "match", group: "minfo", prompt: "a description of how dirt is kept out of stored rainwater", answer: "C",
          explain: "Paragraph C explains the two cleaning devices: the first-flush diverter, which discards the dirty first water, and the screen that stops leaves — how dirt is kept out.",
          evidence: "a device called a first-flush diverter fills with that initial water" },
        { n: 16, type: "match", group: "minfo", prompt: "an explanation of why traditional harvesting structures fell out of use", answer: "B",
          explain: "Paragraph B gives Qureshi's explanation: the old tanks were abandoned once piped municipal water arrived, so 'fell out of use' paraphrases 'were abandoned'.",
          evidence: "The old tanks were abandoned, he says, when piped municipal water arrived",
          vocab: ["abandoned", "fell out of use"] },
        { n: 17, type: "match", group: "minfo", prompt: "a comparison between the cost of harvested water and mains water", answer: "E",
          explain: "Paragraph E holds Haddad's litre-for-litre comparison: once everything is honestly priced, tank water often costs more than the same litre from the mains.",
          evidence: "often costs more than the same litre from the mains" },
        { n: 18, type: "gap", group: "sum2", note: "ONE WORD ONLY",
          ...
          answer: "dust",
          explain: "The discarded first water carries the dust, soot and bird droppings from the roof; 'dust' is the only one of these that fits the ONE WORD limit naturally.",
          evidence: "carries the dust, soot and bird droppings the roof has collected",
          vocab: ["has collected", "has settled"] },
        { n: 19, type: "gap", group: "sum2", answer: "screen",
          explain: "The device over the inlet that keeps leaves out is a screen, so 'screen' fills the gap; 'stops leaves entering' paraphrases 'keeps out leaves'.",
          evidence: "A screen over the inlet keeps out leaves",
          vocab: ["keeps out leaves", "stops leaves entering"] },
        { n: 20, type: "gap", group: "sum2", answer: "gardens",
          explain: "Stored water goes to gardens and toilets; the summary already prints 'toilets', so 'gardens' completes the pair. 'A large share' paraphrases 'half of domestic demand'.",
          evidence: "use the stored water for gardens and toilets",
          vocab: ["half of domestic demand", "a large share"] },
        { n: 21, type: "gap", group: "sum2", answer: "wells",
          explain: "The overflow is led into recharge wells — gravel-filled shafts — so 'wells' completes 'recharge ______'. Keep the plural, and note 'extra water' paraphrases 'the surplus'.",
          evidence: "the overflow is led into recharge wells",
          vocab: ["the surplus", "the extra water"] },
        { n: 22, type: "gap", group: "sum2", answer: "aquifer",
          explain: "The water soaks down to refill the aquifer, the water layer lying below the city, so 'aquifer' fits the gap; 'under the city' paraphrases 'beneath the city'.",
          evidence: "let the water soak down to refill the aquifer beneath the city",
          vocab: ["beneath the city", "under the city"] },
        { n: 23, type: "match", group: "people", boxTitle: "List of People",
          ...
          explain: "It is Haddad, the economist, who prices tank water honestly and finds it often costs more than mains water — 'more expensive' paraphrases 'costs more'.",
          evidence: "water from a household tank often costs more than the same litre",
          vocab: ["costs more", "more expensive"] },
        { n: 24, type: "match", group: "people", prompt: "Old harvesting systems were given up once piped water became available.", answer: "B",
          explain: "Qureshi, who documented the stepwells of Rajasthan, argues the tanks were abandoned when piped municipal water arrived — 'given up' paraphrases 'abandoned'.",
          evidence: "abandoned, he says, when piped municipal water arrived",
          vocab: ["abandoned", "given up"] },
        { n: 25, type: "match", group: "people", prompt: "The true value of harvesting lies in more than the water it collects.", answer: "D",
          explain: "Bell argues the real product is resilience — flood protection and a reserve — not cheap water, so the value goes beyond the litres collected.",
          evidence: "The real product, Bell argues, is not cheap water but resilience",
          vocab: ["real product", "true value"] },
        { n: 26, type: "match", group: "people", prompt: "Groundwater levels have risen where recharge wells are in use.", answer: "A",
          explain: "Delgado is the hydrologist whose instruments in Mexico City record groundwater rising beneath districts served by recharge wells. Petrova, the unused name, only discusses future rainfall.",
          evidence: "her instruments record groundwater levels rising measurably" },
      ],
    },
    {
      title: "Passage 3",
...
The last decade of psychology, with its unsparing insistence on repeating experiments before believing them, has been hard on colour research, and the honest summary is now easy to state. A few effects, such as red's small drag on test performance, have survived replication reasonably well; many others, including most of what fills the marketing textbooks, have shrunk or vanished when tested at proper scale. The reasonable conclusion is not that colour is powerless, but that its powers are real, small and tied tightly to context — a nudge among a hundred larger forces, not a lever. That will disappoint anyone hoping to transform a company with a logo or pacify a prison with a paint roller. It should not disappoint scientists. Small, conditional, learnable effects are exactly what one would expect from a signal that human beings invented most of the meanings for; the interesting work now is mapping when the nudge operates, not repeating the fairy tale that it rules us.`,
      questions: [
        { n: 27, type: "mcq", prompt: "In the first paragraph, the writer suggests that popular claims about colour", options: ["A are based on the latest research", "B are stated with more certainty than the evidence allows", "C have been rejected by the marketing industry", "D apply only to offices and hospitals"], answer: "B",
          explain: "The writer says the confidence of these claims runs far ahead of the evidence — the certainty is greater than the research justifies. A is the opposite; C and D distort details.",
          evidence: "the confidence of these claims runs far ahead of the evidence",
          vocab: ["runs far ahead of", "more certainty than"] },
        { n: 28, type: "mcq", prompt: "What surprised psychologists about the test experiments was that", options: ["A red improved performance on some puzzles", "B participants remembered the colours clearly", "C the effect was larger than any previously found", "D such a minor signal could affect results at all"], answer: "D",
          explain: "The passage says the effect was modest and participants could not recall the colour, so B and C are traps. The surprise was that so small a cue changed scores at all.",
          evidence: "so small a cue could move measured performance at all",
          vocab: ["so small a cue", "minor signal"] },
        { n: 29, type: "mcq", prompt: "What point does the writer make about Baker-Miller pink?", options: ["A Its early results were not confirmed when the work was repeated", "B It is still the standard colour for holding cells", "C It calms some groups of people but not others", "D Its effect becomes stronger with longer exposure"], answer: "A",
          explain: "When other researchers repeated the pink study with proper controls, the calming effect usually failed to appear — so the early results were not confirmed.",
          evidence: "the calming effect usually failed to appear",
          vocab: ["failed to appear", "not confirmed"] },
        { n: 30, type: "mcq", prompt: "In the final paragraph, the writer concludes that colour effects", options: ["A were invented entirely by advertisers", "B depend mainly on an individual's personality", "C exist but are minor and tied to the situation", "D will soon be explained by evolutionary biology"], answer: "C",
          explain: "The conclusion is balanced: colour is not powerless, but its powers are real, small and tied to context — a nudge, not a lever. A overstates; B and D are never claimed.",
          evidence: "its powers are real, small and tied tightly to context",
          vocab: ["tied tightly to context", "tied to the situation"] },
        { n: 31, type: "ynng", prompt: "Some widely repeated claims about colour rest on weak evidence.", answer: "YES",
          explain: "YES: this is the writer's central complaint — the pink-room story spread from a tiny sample and a press release before anyone checked whether the effect was real.",
          evidence: "an appealing result, a tiny sample, a press release" },
        { n: 32, type: "ynng", prompt: "Painting a room pink is a dependable way of calming people.", answer: "NO",
          explain: "NO: replications with proper controls usually found no calming effect, and several studies showed no difference between pink and grey cells — so pink is not dependable.",
          evidence: "several studies found no difference at all between pink cells and grey ones" },
        { n: 33, type: "ynng", prompt: "Blue is the most pleasant colour for most people.", answer: "NOT GIVEN",
          explain: "NOT GIVEN: blue appears only in examples about offices and sports kit; the writer never ranks colours by pleasantness or says which one people prefer.",
          evidence: "paint your office blue and creativity will flow" },
        { n: 34, type: "ynng", prompt: "The message a colour sends depends on the situation in which it appears.", answer: "YES",
          explain: "YES: the colour-in-context theory says exactly this — colours carry situational messages that switch as the setting changes, like red meaning danger, dominance or attraction.",
          evidence: "colours carry not fixed messages but situational ones",
          vocab: ["situational", "depends on the situation"] },
        { n: 35, type: "ynng", prompt: "Most colour associations are fixed in humans at birth.", answer: "NO",
          explain: "NO: the passage argues most colour meaning is learned — a child absorbs the codes like vocabulary rather than inheriting them, and the codes differ across cultures.",
          evidence: "A child does not inherit these codes; a child absorbs them",
          vocab: ["does not inherit", "fixed at birth"] },
        { n: 36, type: "gap", group: "wl",
          ...
          answer: "G",
          explain: "G (samples): the pink study is criticised for its tiny sample, and the gap needs a plural noun after 'small' — so 'samples' is the only choice that fits grammar and meaning.",
          evidence: "an appealing result, a tiny sample, a press release",
          vocab: ["tiny", "small"] },
        { n: 37, type: "gap", group: "wl", answer: "F",
          explain: "F (replication): recent psychology insists on repeating experiments before believing them, and 'replication' is the noun for that repeating — 'attempts at replication' is the natural phrase.",
          evidence: "insistence on repeating experiments before believing them",
          vocab: ["repeating experiments", "replication"] },
        { n: 38, type: "gap", group: "wl", answer: "C",
          explain: "C (context): a colour can send opposite messages because its meaning switches with the setting, so its influence depends on context — the passage's own theory is called colour-in-context.",
          evidence: "switching meaning as the setting changes",
          vocab: ["the setting", "context"] },
        { n: 39, type: "gap", group: "wl", answer: "E",
          explain: "E (learning): the variety of colour meaning across cultures shows most of it is learned — absorbed like vocabulary — so it is a product of learning, not instinct or biology.",
          evidence: "the sheer variety of colour meaning across cultures argues that most of it is learned" },
        { n: 40, type: "gap", group: "wl", answer: "B",
          explain: "B (caution): the writer distrusts confident commercial claims whose certainty outruns the evidence, so we should treat them with caution — 'attention' or 'emotion' would not carry that warning.",
          evidence: "the confidence of these claims runs far ahead of the evidence" },
      ],
    },
  ],
